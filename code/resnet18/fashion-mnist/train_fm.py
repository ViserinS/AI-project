...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, choices=['mnist', 'fashion'], 
                        default='mnist', help='choose dataset: mnist or fashion-mnist')
...
class Trainer:
    def __init__(self, args):
        ...
        # 创建保存目录
        self.checkpoint_dir = 'fashion_mnist/checkpoints_gn'
        os.makedirs(self.checkpoint_dir, exist_ok=True)
        
        # 设置tensorboard
        run_id = datetime.datetime.now().strftime('%Y%m%d-%H%M%S')
        self.writer = SummaryWriter(f'runs/fashion_mnist_gn{run_id}')
